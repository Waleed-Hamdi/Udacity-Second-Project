...
describe('testing order handlers endpoint', () => {
    it('test order show endpoint', () => __awaiter(void 0, void 0, void 0, function* () {
        yield request.get('/order/2').send({
        ...
        it('test order post endpoint', () => __awaiter(void 0, void 0, void 0, function* () {
